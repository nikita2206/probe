...
impl CodeChunker {
    ...
    fn setup_language_parsers(&mut self) -> Result<()> {
        ...
        self.parsers
            .insert("rs".to_string(), (rust_language, rust_parser, rust_query));
        ...
        self.parsers.insert(
            "py".to_string(),
            (python_language, python_parser, python_query),
        );
        ...
        self.parsers
            .insert("js".to_string(), (js_language, js_parser, js_query));
        ...
        self.parsers
            .insert("ts".to_string(), (ts_language, ts_parser, ts_query));
        ...
        self.parsers
            .insert("go".to_string(), (go_language, go_parser, go_query));
        ...
        self.parsers
            .insert("c".to_string(), (c_language, c_parser, c_query));

        // C headers
        let c_h_language = tree_sitter_c::language();
        let mut c_h_parser = Parser::new();
        c_h_parser
            .set_language(c_h_language)
            .context("Failed to set C header language")?;
        let c_h_query = Query::new(
            c_h_language,
            r#"
            (function_definition
                declarator: (function_declarator
        ...
        self.parsers
            .insert("h".to_string(), (c_h_language, c_h_parser, c_h_query));
        ...
        self.parsers
            .insert("cpp".to_string(), (cpp_language, cpp_parser, cpp_query));

        // C++ additional extensions
        let cpp_cc_language = tree_sitter_cpp::language();
        let mut cpp_cc_parser = Parser::new();
        cpp_cc_parser
            .set_language(cpp_cc_language)
            .context("Failed to set C++ cc language")?;
        let cpp_cc_query = Query::new(
            cpp_cc_language,
            r#"
            (function_definition
                declarator: (function_declarator
        ...
        self.parsers.insert(
            "cc".to_string(),
            (cpp_cc_language, cpp_cc_parser, cpp_cc_query),
        );

        let cpp_cxx_language = tree_sitter_cpp::language();
        let mut cpp_cxx_parser = Parser::new();
        cpp_cxx_parser
            .set_language(cpp_cxx_language)
            .context("Failed to set C++ cxx language")?;
        let cpp_cxx_query = Query::new(
            cpp_cxx_language,
            r#"
            (function_definition
                declarator: (function_declarator
        ...
        self.parsers.insert(
            "cxx".to_string(),
            (cpp_cxx_language, cpp_cxx_parser, cpp_cxx_query),
        );

        let cpp_hpp_language = tree_sitter_cpp::language();
        let mut cpp_hpp_parser = Parser::new();
        cpp_hpp_parser
            .set_language(cpp_hpp_language)
            .context("Failed to set C++ hpp language")?;
        let cpp_hpp_query = Query::new(
            cpp_hpp_language,
            r#"
            (function_definition
                declarator: (function_declarator
        ...
        self.parsers.insert(
            "hpp".to_string(),
            (cpp_hpp_language, cpp_hpp_parser, cpp_hpp_query),
        );
        ...
        self.parsers
            .insert("java".to_string(), (java_language, java_parser, java_query));
        ...
        self.parsers.insert(
            "cs".to_string(),
            (csharp_language, csharp_parser, csharp_query),
        );
            ...
            for match_ in matches {
                ...
                if let Some(node) = chunk_node {
                    ...
                    let chunk_content = if matches!(
                        ...
                        Self::extract_class_declaration_with_fields_static(
    ...
    fn extract_class_declaration_with_fields_static(
        content: &str,
        start_byte: usize,
        end_byte: usize,
    ) -> Result<String> {
